...
const HeatDemandFields = () => {
    ...
    >
        {({ values, form }) => (<ContainerThing title="Storage Capacity Calculator">
            ...
            <InfoThing md={3} xs={4} sm={4} textA="Daily need" textB="kWh" value={values.heatDailyEnergyRequired} valueDecimalPlace={0} resetFunction={e => {
            ...
            <InfoThing md={3} xs={4} sm={4} textA="Need met" textB="%" value={values.heatProportionOfCentralHeating} valueDecimalPlace={0} />
