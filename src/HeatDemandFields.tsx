...
const HeatDemandFields = () => {
    ...
    >
        {({ values, form }) => (<ContainerThing title="Storage Capacity Calculator">
            ...
            <InfoThing md={3} xs={4} sm={4} textA="Daily need" textB="kWh" description="Calculated from the annual requirement. 
            If you know the daily requirement override this with the tool icon." 
            value={values.heatDailyEnergyRequired} 
            valueDecimalPlace={0} 
            resetFunction={e => {
