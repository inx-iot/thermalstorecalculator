...
const HouseMenu: React.FC = (): JSX.Element => {
  ...
  const houses = () => {
    return ["1 bedroom flat", "2 bedroom flat", "3 bedroom flat", "4 bedroom flat", "2 bedroom house (Terraced/Semi detached)", "3 bedroom house (Terraced/Semi detached)", "4 bedroom house (Terraced/Semi detached)", "5 bedroom house (Terraced/Semi detached)"];
  };
