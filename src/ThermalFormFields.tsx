...
const ThermalFormFields = () => {
    ...
    >
        {({ values, form }) => (<ContainerThing title="Thermal Store Parameters">
            ...
            <InfoThing textA="Energy Stored" textB="kWh" xs={4} sm={4} md={4} value={values.tankAfterNHoursCooling} description={`Energy remaining after ${values.timeShiftHoursN} hours cooling`}/>
