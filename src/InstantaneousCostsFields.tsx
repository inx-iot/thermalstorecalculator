...
const InstantaneousCostsFields = () => {
    ...
    >
        {({ values, dirtySinceLastSubmit, submitting }) => (<ContainerThing title="Instantaneous Heating Cost Calculator">
            <InfoThing md={4} xs={4} sm={4} textA="Efficiency" description="Efficiency of direct immersion heating" value={100} preValue="%" />
            <InfoThing md={4} xs={4} sm={4} textA="Direct @ flat rate" description="Daily cost of instantaneous direct heating @ flat rate)" value={values.instantaneousHeatingCostFlatRate} preValue="£" />
